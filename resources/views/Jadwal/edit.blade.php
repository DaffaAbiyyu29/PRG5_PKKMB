...
<div class="row justify-content-center mb-5">
	<div class="col-lg-8">
		<div class="card">
            ...
            <form method="POST" action="{{ route('jadwal.update',$jadwal->jdl_idjadwal) }}">
                @csrf
				@method('PUT')
				<div class="row">
					<div class="col-md-6">
						...
						<div class="input-group has-validation mb-4 tanggal">
							<div class="form-floating is-invalid">
								<input type="date" class="form-control" id="jdl_tglpelaksanaan" name="jdl_tglpelaksanaan" data-target="validateField" placeholder="" value="{{ old('jdl_tglpelaksanaan',$jadwal->jdl_tglpelaksanaan) }}">
						...
						<div class="input-group has-validation mb-4 waktumulai">
							<div class="form-floating is-invalid">
								<input type="time" class="form-control" id="waktumulai" name="waktumulai" data-target="validateField" placeholder="" value="{{ old('waktumulai') }}">
						...
						<div class="input-group has-validation mb-4 waktuakhir">
							<div class="form-floating is-invalid">
								<input type="time" class="form-control" id="waktuakhir" name="waktuakhir" data-target="validateField" placeholder="" value="{{ old('waktuakhir') }}">
					...
					<div class="col-md-6">
						...
						<div class="input-group has-validation mb-4 kegiatan">
							<div class="form-floating is-invalid">
								<textarea class="form-control" placeholder="" id="jdl_agenda" data-target="validateField" name="jdl_agenda" style="height: 100px" value="{{ old('jdl_agenda',$jadwal->jdl_agenda) }}"></textarea>
						...
						<div class="input-group has-validation mb-4 jdl_tempat">
							<div class="form-floating is-invalid">
								<textarea class="form-control" placeholder="" id="jdl_tempat" data-target="validateField" name="jdl_tempat" style="height: 100px" value="{{ old('jdl_tempat',$jadwal->jdl_tempat) }}"></textarea>
